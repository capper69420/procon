...
| POST | `/api/triage` | Fuse signals → Level A/B/C |
...
├── health_monitor.py        # Original local webcam app (unchanged)
...
4. POST `/api/triage` — watch the dashboard update in real time
